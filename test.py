...
url_fabra_prec = 'https://api.meteo.cat/xema/v1/variables/mesurades/35/2025/03/14?codiEstacio=D5'
...
response = requests.get(url_update_14mar25, headers={"Content-Type": "application/json", "X-Api-Key": key})
